...
def translate_from_file(file_path="path/to/your/file", sample_rate=1600):
    if "GOOGLE_APPLICATION_CREDENTIALS" not in os.environ:
        os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "/Users/shakil/PycharmProjects/PDFextract_text/finishedProject/keys/speech-to-text-to-translation-8e64c1747824.json"
    print("called")
    print(sample_rate)
